...
//	}
    ...
    public static double getReinforcementValue(int typeId) {
        switch (typeId) {
            case CivData.WATER:
            ...
            case CivData.NETHER_WART_BLOCK:
                return 2;
            case CivData.GRAVEL:
                return 1.25;
            ...
            case CivData.SPONGE:
                return 2.75;
            case CivData.POLISHED_GRANITE:
            case CivData.POLISHED_DIORITE:
            case CivData.POLISHED_ANDESITE:
                return 2.5;
            default:
                return 1;
        }
